...
public class ClaimQueryRepository {
    ...
    public Optional<ClaimDetailsResponse> findDetails(UUID organizationId, UUID claimId) {
        List<ClaimDetailsResponse> result = jdbcTemplate.query(
            ...
            select
                ...
                c.non_payment_confirmation_requested_at,
                c.non_payment_confirmation_requested_by,
                c.document_validation_status,
                c.document_validation_errors,
                c.manual_review_required,
                c.manual_review_reason,
                c.used_sources,
                c.validation_overridden_at,
                c.validation_overridden_by,
                c.validation_override_reason,
                c.assigned_lawyer_id,
                c.final_version_id,
    ...
    private RowMapper<ClaimDetailsResponse> claimDetailsMapper() {
        return (rs, rowNum) -> new ClaimDetailsResponse(
            ...
            getInteger(rs, "response_deadline_days"),
            rs.getString("signer_full_name"),
            rs.getString("signer_position"),
            rs.getString("signer_authority"),
            getUuid(rs, "shipment_id"),
            rs.getString("shipment_number"),
            ...
            getOffsetDateTime(rs, "non_payment_confirmation_requested_at"),
            getUuid(rs, "non_payment_confirmation_requested_by"),
            DocumentValidationStatus.valueOf(rs.getString("document_validation_status")),
            rs.getString("document_validation_errors"),
            rs.getBoolean("manual_review_required"),
            rs.getString("manual_review_reason"),
            rs.getString("used_sources"),
            getOffsetDateTime(rs, "validation_overridden_at"),
            getUuid(rs, "validation_overridden_by"),
            rs.getString("validation_override_reason"),
            getUuid(rs, "assigned_lawyer_id"),
