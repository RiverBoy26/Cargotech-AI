...
public class LoadingFailureActPromptBuilder {
    ...
    private String buildSystemPrompt() {
        return """
                ...
                11. Тон документа — официальный, фактический, без эмоциональных оценок.
                12. Верни только валидный JSON без markdown и без текста вне JSON.
                13. manual_review_required всегда true.
                """;
    }
