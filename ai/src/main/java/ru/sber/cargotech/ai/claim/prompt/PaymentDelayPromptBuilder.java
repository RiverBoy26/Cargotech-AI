...
public class PaymentDelayPromptBuilder {
    ...
    private String buildSystemPrompt() {
        return """
                ...
                45. Не объединяй разные ссылки так, чтобы их нельзя было однозначно проверить. Групповые ссылки вида «п. 8.2, 8.4 Договора» и «ст. 309, 314 ГК РФ» допустимы, если каждая указанная норма действительно использована.
                """;
    }
    ...
    private String buildUserPrompt(GenerateClaimRequest request) {
        ...
        return """
                ...
                10. Отдельный абзац с правовым обоснованием: минимум одна применимая citation из legal_context. До правовых норм укажи точные применимые пункты договора из contract_context.
