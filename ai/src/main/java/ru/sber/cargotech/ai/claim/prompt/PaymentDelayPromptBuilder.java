...
public class PaymentDelayPromptBuilder {
    ...
    private String buildSystemPrompt() {
        return """
                ...
                53. В блоке требований не скрывай состав суммы: отдельно укажи основной долг; при положительной санкции — отдельно санкцию/проценты с правильным названием; затем отдельной строкой общий итог.
                """;
    }
    ...
    private String buildUserPrompt(GenerateClaimRequest request) {
        ...
        return """
                ...
                11. Блок требований начни формой «<creditor.name> требует:», а не «требую». Отдельно укажи основной долг, отдельно положительную санкцию/проценты и затем точную total_amount.
