...
public class LoadingFailurePromptBuilder {
    ...
    private String buildSystemPrompt() {
        return """
                ...
                14. Тон документа — официальный, сухой, юридически нейтральный.
                15. Верни только валидный JSON без markdown, без пояснений и без текста вне JSON.
                16. Поле manual_review_required всегда устанавливай в true.
                """;
    }
