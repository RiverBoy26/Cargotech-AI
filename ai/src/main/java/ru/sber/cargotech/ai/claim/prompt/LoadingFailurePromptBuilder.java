...
public class LoadingFailurePromptBuilder {
    ...
    private String buildSystemPrompt() {
        return """
                ...
                22. Не называй приложение оригиналом или копией: тип экземпляра документа во входных данных отсутствует.
                23. В used_contract_clauses и used_law_articles включай только источники, которые прямо процитированы в claim_text.
                """;
    }
    ...
    private String buildUserPrompt(GenerateClaimRequest request) {
        ...
        return """
                ...
                5. Каждую указанную норму явно процитируй в claim_text вместе с номером статьи и названием закона, например «ст. 330 ГК РФ».
                ...
                5. Не добавляй к названию документа слова «оригинал», «копия», «оригинал прилагается» или «копия прилагается».
