...
public class LoadingFailurePromptBuilder {
    ...
    private String buildUserPrompt(GenerateClaimRequest request) {
        ...
        return """
                ...
                12. Сформируй отдельный абзац с правовым обоснованием. Если legal_context не пуст, процитируй минимум одну применимую норму, дословно используя её поле citation.
